...
CHALLENGES = [
    ...
    },
    {
        ...
        "description": (
            ...
            "real scenarios — public blob → ACR image (secrets hidden in image "
            "layers) → Container Instance → Data Factory → App Configuration → "
            "Monitor action group → APIM named value → Key Vault — until you can "
            "read the Key Vault secret.\n\n"
