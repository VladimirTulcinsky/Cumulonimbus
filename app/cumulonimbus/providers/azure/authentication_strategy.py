...
class AzureCredentials:
    ...
    def __init__(self,
        ...
        # Azure Resource Manager API credentials
    ...
    def get_tenant_id(self):
        if self.tenant_id:
            ...
            try:
                access_token = self.identity_credentials.get_token(
                    "https://management.core.windows.net/.default")
                h = {'Authorization': f'Bearer {access_token.token}'}
                r = requests.get(
                    'https://management.azure.com/tenants?api-version=2020-01-01', headers=h)
                r2 = r.json()
                return r2.get('value')[0].get('tenantId')
            except Exception as e:
                print(f'Unable to infer tenant ID: {e}')
                return None
...
class AzureAuthenticationStrategy(AuthenticationStrategy):
    ...
    def authenticate(self,
        ...
        try:
            ...
            identity_credentials.get_token(
                "https://management.core.windows.net/.default")
