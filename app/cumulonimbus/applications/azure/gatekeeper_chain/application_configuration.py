...
class ApplicationConfiguration(ApplicationConfigurationAbstract):
    ...
    def get_hints(self) -> dict:
        return {
            ...
            3: "The ladder walks the real plaintext-credential scenarios in this order: Container Instance env (`az container show`) -> App Configuration (`az appconfig kv list --auth-mode login`) -> Monitor action group (`az monitor action-group show`) -> APIM named value (`az apim nv show ... --named-value-id flag-key`).",
    ...
    def pretty_print_tf_output(self, app_id, output):
        ...
        print("  public blob -> Container Instance -> App Configuration")
